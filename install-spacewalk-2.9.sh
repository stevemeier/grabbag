...
curl ${CURLOPTS} -O http://mirror.rackspace.com/CentOS/7/isos/x86_64/CentOS-7-x86_64-NetInstall-1810.iso

cat >> /etc/fstab <<EOF
/var/iso-images/CentOS-6.10-x86_64-netinstall.iso           /var/distro-trees/CentOS-6-x86_64       iso9660 loop,ro 0 0
/var/iso-images/CentOS-7-x86_64-NetInstall-1810.iso        /var/distro-trees/CentOS-7-x86_64       iso9660 loop,ro 0 0
EOF
